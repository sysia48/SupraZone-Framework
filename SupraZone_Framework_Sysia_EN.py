# =========================================================
#  SUPRA ZONE FRAMEWORK — SPIRAL RESONANCE PROOF (v3)
# =========================================================
...
def run_suprazone_sim():
    ...
    # --- Main Equation (Spiral Resonance Proof) ---
    ...
    plt.figure(figsize=(12, 5))
    plt.plot(freq, fft_vals, linewidth=1.2)
    ...
    # --- Visualization 3: Energy Heatmap ---
    window = 200
